...
src/
  ...
  data/
    ...
    npcMaps.ts             NPC ที่มีมินิแมป (สร้างด้วยสคริปต์ อย่าแก้มือ)
...
public/
  ...
  icons/maps/              มินิแมปปักหมุดจุดที่ NPC ยืน 24 ภาพ
...
ตอนนี้ได้ 24 จาก 31 ตัว อีก 7 ตัว (Lifeguard Deen, Lifeguard Bean, Tinnie, Compounder Paul,
Item Girl, Marinel, Model Mermaid Babe) หน้าวิกิวางโครง HTML ต่างออกไปเลยจับคู่ไม่ได้
การ์ดของ NPC พวกนี้จะแสดงแค่สไปรต์ ซึ่งไม่พังอะไร เพราะชื่อแผนที่บอกเป็นข้อความอยู่แล้ว
ถ้าจะทำต่อให้ครบ ดูตัวแปร `MAP_ROW` ในสคริปต์ แล้วเทียบกับ HTML จริงของ NPC ที่ยังขาด
